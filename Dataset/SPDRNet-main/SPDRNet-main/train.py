...
from processor import do_multi_scene_train
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="ReID Multi-scene Training")
    ...
    logger = setup_logger("ISGAViTReID", output_dir, if_train=True)
