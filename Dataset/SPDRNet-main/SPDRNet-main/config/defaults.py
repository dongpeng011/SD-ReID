...
_C.MODEL.PRETRAIN_PATH = 'E:/董鹏/VersReID-main/VersReID-main/ckpts/dino_mpda_vit_b_lupb.pth'
...
# selected from ['dslr_cuhk03', 'market1501', 'msmt17', 'celebrity', 'prcc', 'occluded_duke', 'sysumm01', 'con_reid','combine']
...
_C.DATASETS.ROOTS = ['data/market1501' ]
# which dataset we want to combine
_C.DATASETS.COMBINE_NAMES = ['market1501']
...
_C.DATALOADER.COMBINE_SAMPLER = 'scene_balance'
...
_C.OUTPUT_DIR = "outputmodel"

# 在cfg.MODEL下添加
_C.MODEL.USE_FEATURE_DECOUPLING = True       # 启用特征解耦
_C.MODEL.DECOUPLE_RATIO = 0.6                 # 特征解耦比例
